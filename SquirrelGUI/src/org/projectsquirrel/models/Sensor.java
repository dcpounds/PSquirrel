...
public class Sensor {
	...
	/**
	 * @param type The type of sensor this data is for.
	 * @param sensorId The unique sensor id.
	 * @param value The measured value of the sensor. -1 if there is an error with the data.
	 */
	...
	/**
	 * @param json A {@link String} with the Sensor information in Json object form.
	...
	/**
	 * @param value The measured value of the sensor.
	 */
