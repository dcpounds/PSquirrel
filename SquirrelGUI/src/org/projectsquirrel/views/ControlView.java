...
public class ControlView extends JPanel {
	...
	public ControlView(){
        ...
        cameraLeftBtn.addActionListener(new SendCommandController(LEFT, CAMERA));
        add(cameraLeftBtn, "cell 3 1,grow");
        
        JToggleButton cameraRightBtn = new JToggleButton("Right");
        cameraRightBtn.addActionListener(new SendCommandController(RIGHT, CAMERA));
        ...
        robotRightBtn.addActionListener(new SendCommandController(RIGHT, MOTOR));
